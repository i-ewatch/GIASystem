...
{
    public partial class Straight_GIAScreenControl : Field4UserControl
    {
        /// <summary>
        /// 切換畫面頁數
        /// </summary>
        ...
        public Straight_GIAScreenControl(GateWay gateWay, List<Taiwan_DistricsSetting> taiwan_DistricsSetting, GIAScreenMediaSetting screenMediaSetting, List<AbsProtocol> absProtocols)
        {
            InitializeComponent();
        ...
        private void Change_BigScreenMedia(GIAScreenMediaSetting screen, NavigationFrame navigation)
        {
            ...
            else
            {
                ...
                {
                    Straight_GIABigControl bigSenser = new Straight_GIABigControl(screen.ScreenSwitches[0].SenserTypeEnum1, GateWay, GateWaySenserID, GateWayAPI, screen, false) { Dock = DockStyle.Fill };
                    BigUserControls.Add(bigSenser);
                    navigation.AddPage(bigSenser);
                }
                if (screen.ScreenSwitches[0].VisibleFlag2)
                {
                    Straight_GIABigControl bigSenser = new Straight_GIABigControl(screen.ScreenSwitches[0].SenserTypeEnum2, GateWay, GateWaySenserID, GateWayAPI, screen, false) { Dock = DockStyle.Fill };
                    BigUserControls.Add(bigSenser);
                    navigation.AddPage(bigSenser);
                }
        ...
        private void Change_SmallScreenMedia(GIAScreenMediaSetting screen, NavigationFrame navigation, int Index)
        {
            ...
            else
            {
                ...
                {
                    Straight_GIASmallControl smallSenser = new Straight_GIASmallControl(screen.ScreenSwitches[Index].SenserTypeEnum1, GateWay, GateWaySenserID, GateWayAPI, screen, false) { Dock = DockStyle.Fill };
                    SmallUserControls.Add(smallSenser);
                    navigation.AddPage(smallSenser);
                }
                if (screen.ScreenSwitches[Index].VisibleFlag2)
                {
                    Straight_GIASmallControl smallSenser = new Straight_GIASmallControl(screen.ScreenSwitches[Index].SenserTypeEnum2, GateWay, GateWaySenserID, GateWayAPI, screen, false) { Dock = DockStyle.Fill };
                    SmallUserControls.Add(smallSenser);
                    navigation.AddPage(smallSenser);
                }
                navigation.SelectedPageIndex = 0;
        ...
        public override void TextChange()
        {
            ...
            if (Senserspan.TotalSeconds >= 2)
            {
                if (AbsProtocols != null)
                {
                    ...
                    {
                        var bigsenser = (Straight_GIABigControl)Bignavigation.Pages[Bignavigation.SelectedPageIndex].Controls[0];
                        bigsenser.AbsProtocols = AbsProtocols;
                        bigsenser.TextChange();
                    }
                    if (Smallnavigation1.SelectedPageIndex > -1)
                    {
                        var smallsenser1 = (Straight_GIASmallControl)Smallnavigation1.Pages[Smallnavigation1.SelectedPageIndex].Controls[0];
                        smallsenser1.AbsProtocols = AbsProtocols;
                        smallsenser1.TextChange();
                    }
                    if (Smallnavigation2.SelectedPageIndex > -1)
                    {
                        var smallsenser2 = (Straight_GIASmallControl)Smallnavigation2.Pages[Smallnavigation2.SelectedPageIndex].Controls[0];
                        smallsenser2.AbsProtocols = AbsProtocols;
                        smallsenser2.TextChange();
                    }
                    if (Smallnavigation3.SelectedPageIndex > -1)
                    {
                        var smallsenser3 = (Straight_GIASmallControl)Smallnavigation3.Pages[Smallnavigation3.SelectedPageIndex].Controls[0];
                        smallsenser3.AbsProtocols = AbsProtocols;
                        smallsenser3.TextChange();
                    }
                    if (Smallnavigation4.SelectedPageIndex > -1)
                    {
                        var smallsenser4 = (Straight_GIASmallControl)Smallnavigation4.Pages[Smallnavigation4.SelectedPageIndex].Controls[0];
                        smallsenser4.AbsProtocols = AbsProtocols;
                        smallsenser4.TextChange();
                    }
                    if (Smallnavigation5.SelectedPageIndex > -1)
                    {
                        var smallsenser5 = (Straight_GIASmallControl)Smallnavigation5.Pages[Smallnavigation5.SelectedPageIndex].Controls[0];
                        smallsenser5.AbsProtocols = AbsProtocols;
                        smallsenser5.TextChange();
                    }
                    if (Smallnavigation6.SelectedPageIndex > -1)
                    {
                        var smallsenser6 = (Straight_GIASmallControl)Smallnavigation6.Pages[Smallnavigation6.SelectedPageIndex].Controls[0];
