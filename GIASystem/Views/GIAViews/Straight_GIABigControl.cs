...
{
    public partial class Straight_GIABigControl : Field4UserControl
    {
        /// <summary>
        /// 感測器類型
        /// </summary>
        ...
        public Straight_GIABigControl(int senserTypeEnum, GateWay gateWay, GateWaySenserID gateWaySenserID, GateWayAPI gateWayAPI, GIAScreenMediaSetting screenMediaSetting, bool screenTransition)
        {
            InitializeComponent();
            GateWay = gateWay;
        ...
        private void LeftpictureBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            Bitmap bmp = (Bitmap)imageCollection1.Images["16x820_左.png"];
            {
        ...
        private void RightpictureBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            Bitmap bmp = (Bitmap)imageCollection1.Images["16x820_右.png"];
            {
                ColorMap[] colorMaps = new ColorMap[1];
                colorMaps[0] = new ColorMap();
                colorMaps[0].OldColor = Color.FromArgb(246, 246, 246);
