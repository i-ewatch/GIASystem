...
{
    public partial class Horizontal_GIABigControl : Field4UserControl
    {
        /// <summary>
        /// 感測器類型
        /// </summary>
        ...
        public Horizontal_GIABigControl(int senserTypeEnum, GateWay gateWay, GateWaySenserID gateWaySenserID, GateWayAPI gateWayAPI, GIAScreenMediaSetting screenMediaSetting, bool screenTransition)
        {
            InitializeComponent();
            GateWay = gateWay;
        ...
        private void LeftpictureBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            Bitmap bmp = (Bitmap)imageCollection1.Images["SenserBig_left.png"];
            {
        ...
        private void RightpictureBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            Bitmap bmp = (Bitmap)imageCollection1.Images["SenserBig_right.png"];
            {
                ColorMap[] colorMaps = new ColorMap[1];
                colorMaps[0] = new ColorMap();
                colorMaps[0].OldColor = Color.FromArgb(255, 255, 255);
