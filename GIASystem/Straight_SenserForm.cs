...
namespace GIASystem
{
    public partial class Straight_SenserForm : XtraForm
    {
        /// <summary>
        /// 初始路徑
        /// </summary>
        ...
        /// 天氣資訊
        /// </summary>
        public Straight_WeatherControl Straight_WeatherControl { get; set; }
        /// <summary>
        /// 感測器畫面
        /// </summary>
        public Straight_GIAScreenControl Straight_GIAScreenControl { get; set; }
        /// <summary>
        /// 設定按鈕
        /// </summary>
        public SettingButtonControl SettingButtonControl { get; set; }
        #endregion
        public Straight_SenserForm()
        {
            InitializeComponent();
            #region serialog
            ...
            if (GateWaySetting.ControlFlag)//使用通訊
            {
                ...
                {
                    GatewayEnumType = (GatewayEnumType)Gateitem.GIAGatewayEnumType;
            ...
            #region Views
            MarqueeControl = new MarqueeControl(MarqueeSetting, ScreenMediaSetting, new Point(1081, 17)) { Dock = DockStyle.Fill, Parent = MarqueepanelControl };
            VideoControl = new VideoControl(MediaPlaySetting) { Dock = DockStyle.Fill, Parent = VediopanelControl1 };
                        ...
                        case Enums.SenserEnumType.GIA:
                            {
                                ...
                                {
                                    Straight_GIAScreenControl = new Straight_GIAScreenControl(GateWay, Taiwan_DistricsSetting, ScreenMediaSetting, AbsProtocols) { Dock = DockStyle.Fill, Parent = SenserpanelControl };
                                }
                            }
                            break;
                    }
                ...
                foreach (var item in GateWay.GateWayAPIs)
                {
                    ...
                    switch (APIEnumType)
                    {
                        case Enums.APIEnumType.WeatherAPI:
                            {
                                Straight_WeatherControl = new Straight_WeatherControl(GateWay, Taiwan_DistricsSetting, item, AbsProtocols, GIA_DistricsSetting) { Dock = DockStyle.Fill, Parent = WeatherpanelControl };
                            }
                            break;
            ...
            SettingButtonControl = new SettingButtonControl(null, null, this);
            #endregion
            #region 設定按鈕顯示
        ...
        #region 視窗建置後初始位址
        private void Straight_SenserForm_Load(object sender, EventArgs e)
        {
        ...
        #region 關閉視窗
        public void Straight_SenserForm_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (Straight_WeatherControl != null)
            {
                Straight_WeatherControl.TextChange();
            }
            if (Straight_GIAScreenControl != null)
            {
                Straight_GIAScreenControl.TextChange();
            }
            ComponentFail();
        }
        #endregion
