...
namespace GIASystem
{
    public partial class Horizontal_SenserForm : XtraForm
    {
        /// <summary>
        /// 初始路徑
        /// </summary>
        ...
        public Horizontal_SenserForm()
        {
            ...
            VideoControl = new VideoControl(MediaPlaySetting) { Dock = DockStyle.Fill, Parent = VediopanelControl };
            ...
            SettingButtonControl = new SettingButtonControl(this, null, null);
            #endregion
            #region 設定按鈕顯示
        ...
        #region 視窗建置後初始位址
        private void Horizontal_SenserForm_Load(object sender, EventArgs e)
        {
        ...
        #region 關閉視窗
        public void Horizontal_SenserForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            foreach (var Componentitem in Field4Components)
            {
